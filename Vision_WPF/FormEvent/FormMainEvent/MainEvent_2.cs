...
namespace FormEvent
{
    public class MainEvent_2 : IMainEvent_2
    {
        ...
        private ImageFileControl_2 imageFileControl;
        ...
        public async Task testCycle(int index, Form_Main form, int result, (int x, int y) AlignValues)
        {
            ...
            // 주소값을 조회
            Dictionary<string, string> address = AddressMap_2.address(index);
        ...
        public async void toggleLiveMode(int cameraIndex, bool isLiveMode, CogDisplay display)
        {
            try
            {
        ...
        {
            await imageFileControl.loadImage(getImageFilePath(), display);
        }
    ...
    public static class AddressMap_2
    {
